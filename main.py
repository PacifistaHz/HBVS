...
df.to_csv('genisletilmis_hepsiburada_satis_veri_seti.csv', index=False)

print("Genişletilmiş veri seti oluşturuldu ve 'genisletilmis_hepsiburada_satis_veri_seti.csv' olarak kaydedildi.")
